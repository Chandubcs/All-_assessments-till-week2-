...
import com.deloitte.ecommerce.service.EwalletServiceImpl;
...
public class EwalletUi {
    ...
    private void runUi() {
        try {
            Ewallet e1 = new Ewallet("4785934578", "chandu",234.0,"password1");
            Ewallet e2 = new Ewallet("5678345678", "robo",100.0,"passsword2");
